...
func TestInitialize4Bit_directionOut(t *testing.T) {
	...
	NewGPIO(mock.rs, mock.en, mock.d4, mock.d5, mock.d6, mock.d7, mock.backlight, Negative, cols, rows)
...
func TestInitialize4Bit_lcdInit(t *testing.T) {
	mock := newMockGPIOConnection()
	gpio, _ := NewGPIO(mock.rs, mock.en, mock.d4, mock.d5, mock.d6, mock.d7, mock.backlight, Negative, cols, rows)
...
func TestGPIOConnectionClose(t *testing.T) {
	mock := newMockGPIOConnection()
	bus, _ := NewGPIO(mock.rs, mock.en, mock.d4, mock.d5, mock.d6, mock.d7, mock.backlight, Negative, cols, rows)
	bus.Close()
	for idx, pin := range mock.pins() {
		if !pin.closed {
...
func TestDefaultModes(t *testing.T) {
	display, _ := New(newMockGPIOConnection(), cols, rows)
